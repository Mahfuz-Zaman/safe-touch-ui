...
export class ReviewControlService {
  ...
  editReview(data: ReviewControl) {
    return this.httpClient.put<{ message: string }>(API_REVIEW_CONTROL + 'edit-review-by-admin', data);
  }
  editReviewByUser(data: ReviewControl) {
    return this.httpClient.put<{ message: string }>(API_REVIEW_CONTROL + 'edit-review-by-user', data);
  }
