...
export class AdditionalPagesComponent implements OnInit {
  ...
  allPages: object[] = [
    {_id: 1, name: 'Why Shop Online At safetouch', slug: 'why-shop-online-at-safetouch'},
    ...
    {_id: 16, name: 'Installation & Repair', slug: 'installation-and-repair'},
    ...
    {_id: 20, name: 'Career at safetouch', slug: 'career-at-safetouch'},
